...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        ColorStateList tabTextColor = a.getColorStateList(R.styleable.PagerSlidingTabStrip_android_textColor);
        ...
        textAllCaps = a.getBoolean(R.styleable.PagerSlidingTabStrip_android_textAllCaps, textAllCaps);
        minTabWidth = (int) a.getDimension(R.styleable.PagerSlidingTabStrip_pstsTabMinWidth, minTabWidth);
        tabTypefaceStyle = a.getInteger(R.styleable.PagerSlidingTabStrip_android_textStyle, tabTypefaceStyle);
